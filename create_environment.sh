...
bliss,Shell Navigation, submitted
Alice, Shell Navigation, not submitted
Mahoro, Shell Navigation, submitted
...
echo "WOW YOU CAN NOW RUN YOUR REMINDER APP JUST TYPE ./submission_reminder_app/startup.sh AND SEE THE MAGIC"
